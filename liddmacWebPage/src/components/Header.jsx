                ...
                <div id="header-wrap">
                    <div className="container">
                        <div className="header-row">
                            ...
                            <div id="logo">
                                <a href="index.html" className="standard-logo" data-dark-logo="src/images/logo-dark.png"><img
                                    src="src/images/logo.png" alt="Canvas Logo" /></a>
                                <a href="index.html" className="retina-logo" data-dark-logo="src/images/logo-dark@2x.png"><img
                                    src="src/images/logo@2x.png" alt="Canvas Logo" /></a>
                            </div>
                            ...
                            <div className="header-misc">
                                ...
                                <div id="top-cart" className="header-misc-icon d-none d-sm-block">
                                    <a href="#" id="top-cart-trigger"><i className="icon-line-bag"></i><span
                                        className="top-cart-number">5</span></a>
                                        ...
                                        <div className="top-cart-items">
                                            <div className="top-cart-item">
                                                <div className="top-cart-item-image">
                                                    <a href="#"><img src="src/images/shop/small/1.jpg"
                                            ...
                                            <div className="top-cart-item">
                                                <div className="top-cart-item-image">
                                                    <a href="#"><img src="src/images/shop/small/6.jpg"
                                ...
                                <ul className="menu-container">
                                    <li className="menu-item">
                                        ...
                                        <ul className="sub-menu-container">
                                            <li className="menu-item">
                                                <a className="menu-link" href="intro.html#section-niche">
                                                    <div>Niche Demos</div>
                                                </a>
                                            </li>
                                            <li className="menu-item">
                                                <a className="menu-link" href="intro.html#section-onepage">
                                            ...
                                            <li className="menu-item">
                                                ...
                                                <ul className="sub-menu-container">
                                                    ...
                                                    <li className="menu-item">
                                                        <a className="menu-link" href="index-corporate-2.html">
                                                            <div>Corporate - Layout 2</div>
                                                        </a>
                                                    </li>
                                                    <li className="menu-item">
                                                        <a className="menu-link" href="index-corporate-3.html">
                                                            <div>Corporate - Layout 3</div>
                                                        </a>
                                                    </li>
                                                    <li className="menu-item">
                                                        <a className="menu-link" href="index-corporate-4.html">
                                            ...
                                            <li className="menu-item">
                                                ...
                                                <ul className="sub-menu-container">
                                                    ...
                                                    <li className="menu-item">
                                                        <a className="menu-link" href="index-portfolio-2.html">
                                                            <div>Portfolio - Layout 2</div>
                                                        </a>
                                                    </li>
                                                    <li className="menu-item">
                                                        <a className="menu-link" href="index-portfolio-3.html">
                                                            <div>Portfolio - Masonry</div>
                                                        </a>
                                                    </li>
                                                    <li className="menu-item">
                                                        <a className="menu-link" href="index-portfolio-4.html">
                                            ...
                                            <li className="menu-item">
                                                <a className="menu-link" href="index-fullscreen-image.html">
                                                ...
                                                <ul className="sub-menu-container">
                                                    ...
                                                    <li className="menu-item">
                                                        <a className="menu-link" href="index-fullscreen-slider.html">
                                                            <div>Full Screen - Slider</div>
                                                        </a>
                                                    </li>
                                                    <li className="menu-item">
                                                        <a className="menu-link" href="index-fullscreen-video.html">
                                                ...
                                                <div className="mega-menu-content">
                                                    <div className="row mx-0">
                                                        <ul className="sub-menu-container mega-menu-column col">
                                                            <li className="menu-item">
                                                                <a className="menu-link" href="index-wedding.html">
                                                                    <div>Wedding</div>
                                                                </a>
                                                            </li>
                                                            <li className="menu-item">
                                                                <a className="menu-link" href="index-restaurant.html">
                                                                    <div>Restaurant</div>
                                                                </a>
                                                            </li>
                                                            <li className="menu-item">
                                                        ...
                                                        <ul className="sub-menu-container mega-menu-column col">
                                                            <li className="menu-item">
                                                                <a className="menu-link" href="index-parallax.html">
                                                                    <div>Parallax</div>
                                                                </a>
                                                            </li>
                                                            <li className="menu-item">
                                                                <a className="menu-link" href="index-app-showcase.html">
                                    ...
                                    <li className="menu-item">
                                        ...
                                        <ul className="sub-menu-container">
                                            <li className="menu-item">
                                                ...
                                                <ul className="sub-menu-container">
                                                    <li className="menu-item">
                                                        <a className="menu-link" href="slider-revolution.html">
                                                        ...
                                                        <ul className="sub-menu-container">
                                                            ...
                                                            <li className="menu-item">
                                                                <a className="menu-link" href="slider-revolution-kenburns.html">
                                                    ...
                                                    <li className="menu-item">
                                                        ...
                                                        <ul className="sub-menu-container">
                                                            ...
                                                            <li className="menu-item">
                                                                <a className="menu-link" href="slider-canvas-fade.html">
                                                                    <div>Fade Transition</div>
                                                                </a>
                                                            </li>
                                                            <li className="menu-item">
                                                                <a className="menu-link" href="slider-canvas-autoplay.html">
                                                                    <div>Autoplay Feature</div>
                                                                </a>
                                                            </li>
                                                            <li className="menu-item">
                                                                <a className="menu-link" href="slider-canvas-video-event.html">
                                                                    <div>Custom Video Event</div>
                                                                </a>
                                                            </li>
                                                            <li className="menu-item">
                                                                <a className="menu-link" href="slider-canvas-pagination.html">
                                                                    <div>Pagination Navigation</div>
                                                                </a>
                                                            </li>
                                                            <li className="menu-item">
                                                                <a className="menu-link" href="slider-canvas-3.html">
                                                                    <div>3 Columns</div>
                                                                </a>
                                                            </li>
                                                            <li className="menu-item">
                                                                <a className="menu-link" href="slider-canvas-4.html">
                                                                    <div>4 Columns</div>
                                                                </a>
                                                            </li>
                                                            <li className="menu-item">
                                                                <a className="menu-link" href="slider-canvas-5.html">
                                                                    <div>5 Columns</div>
                                                                </a>
                                                            </li>
                                                        </ul>
                                                    ...
                                                    <li className="menu-item">
                                                        ...
                                                        <ul className="sub-menu-container">
                                                            ...
                                                            <li className="menu-item">
                                                                <a className="menu-link" href="slider-flex-thumbs.html">
                                                                    <div>with Thumbs</div>
                                                                </a>
                                                            </li>
                                                        </ul>
                                                    ...
                                                    <li className="menu-item">
                                                        ...
                                                        <ul className="sub-menu-container">
                                                            <li className="menu-item">
                                                                <a className="menu-link" href="slider-owl-full.html">
                                                                    <div>Full Width</div>
                                                                </a>
                                                            </li>
                                                            <li className="menu-item">
                                                            ...
                                                            <li className="menu-item">
                                                                <a className="menu-link" href="slider-owl-videos.html">
                                                    ...
                                                    <li className="menu-item">
                                                        ...
                                                        <ul className="sub-menu-container">
                                                            ...
                                                            <li className="menu-item">
                                                                <a className="menu-link" href="static-thumbs-grid.html">
                                                                    <div>Static - Thumb Gallery</div>
                                                                </a>
                                                            </li>
                                                            <li className="menu-item">
                                                                <a className="menu-link" href="static-html5-video.html">
                                                                    <div>Static - HTML5 Video</div>
                                                                </a>
                                                            </li>
                                                            <li className="menu-item">
                                                                <a className="menu-link" href="static-embed-video.html">
                                            ...
                                            <li className="menu-item">
                                                ...
                                                <ul className="sub-menu-container">
                                                    ...
                                                    <li className="menu-item">
                                                        <a className="menu-link" href="header-transparent.html">
                                                            <div>Transparent</div>
                                                        </a>
                                                    </li>
                                                    <li className="menu-item">
                                                        <a className="menu-link" href="header-semi-transparent.html">
                                                    ...
                                                    <li className="menu-item">
                                                        ...
                                                        <ul className="sub-menu-container">
                                                            ...
                                                            <li className="menu-item">
                                                                <a className="menu-link" href="header-side-left-open.html">
                                                                    <div>OnClick Open</div>
                                                                </a>
                                                            </li>
                                                            <li className="menu-item">
                                                                <a className="menu-link" href="header-side-left-open-push.html">
                                                    ...
                                                    <li className="menu-item">
                                                        <a className="menu-link" href="header-side-right.html">
                                                        ...
                                                        <ul className="sub-menu-container">
                                                            ...
                                                            <li className="menu-item">
                                                                <a className="menu-link" href="header-side-right-open.html">
                                                                    <div>OnClick Open</div>
                                                                </a>
                                                            </li>
                                                            <li className="menu-item">
                                                    ...
                                                    <li className="menu-item">
                                                        <a className="menu-link" href="responsive-sticky.html">
                                                    ...
                                                    <li className="menu-item">
                                                        <a className="menu-link" href="alternate-mobile-menu.html">
                                                ...
                                                <div className="mega-menu-content">
                                                    <div className="row mx-0">
                                                        ...
                                                        <ul className="sub-menu-container mega-menu-column col">
                                                            ...
                                                            <li className="menu-item">
                                                                <a className="menu-link" href="menu-subtitle.html">
                                            ...
                                            <li className="menu-item">
                                                ...
                                                <ul className="sub-menu-container">
                                                    ...
                                                    <li className="menu-item">
                                                        <a className="menu-link" href="mega-menu-side-tab.html">
                                                ...
                                                <div className="mega-menu-content">
                                                    <div className="row mx-0">
                                                        <ul className="sub-menu-container mega-menu-column col-5">
                                                            <li className="menu-item">
                                                                <a className="menu-link" href="page.html">
                                                                    <div>Left Align</div>
                                                                </a>
                                                            </li>
                                                            <li className="menu-item">
                                                                <a className="menu-link" href="page-title-right.html">
                                                                    <div>Right Align</div>
                                                                </a>
                                                            </li>
                                                            <li className="menu-item">
                                                                <a className="menu-link" href="page-title-center.html">
                                                                    <div>Center Align</div>
                                                                </a>
                                                            </li>
                                                            <li className="menu-item">
                                                                <a className="menu-link" href="page-title-dark.html">
                                                                    <div>Dark Style</div>
                                                                </a>
                                                            </li>
                                                            <li className="menu-item">
                                                                <a className="menu-link" href="page-title-pattern.html">
                                                                    <div>BG Pattern</div>
                                                                </a>
                                                            </li>
                                                        </ul>
                                                        <ul className="sub-menu-container mega-menu-column col-7">
                                                            <li className="menu-item">
                                                                <a className="menu-link" href="page-title-parallax.html">
                                                                    <div>Parallax - Default</div>
                                                                </a>
                                                            </li>
                                                            <li className="menu-item">
                                                                <a className="menu-link" href="page-title-parallax-header.html">
                                                                    <div>Parallax - Transparent</div>
                                                                </a>
                                                            </li>
                                                            <li className="menu-item">
                                                                <a className="menu-link" href="page-title-video.html">
                                                                    <div>HTML5 Video</div>
                                                                </a>
                                                            </li>
                                                            <li className="menu-item">
                                                                <a className="menu-link" href="page-title-nobg.html">
                                                                    <div>No Background</div>
                                                                </a>
                                                            </li>
                                                            <li className="menu-item">
                                                                <a className="menu-link" href="page-title-mini.html">
                                            ...
                                            <li className="menu-item">
                                                ...
                                                <ul className="sub-menu-container">
                                                    <li className="menu-item">
                                                        <a className="menu-link" href="side-panel-left-overlay.html">
                                                            <div>Left Overlay</div>
                                                        </a>
                                                    </li>
                                                    <li className="menu-item">
                                                        <a className="menu-link" href="side-panel-left-push.html">
                                                            <div>Left Push</div>
                                                        </a>
                                                    </li>
                                                    <li className="menu-item">
                                                        <a className="menu-link" href="side-panel-right-overlay.html">
                                            ...
                                            <li className="menu-item">
                                                ...
                                                <ul className="sub-menu-container">
                                                    ...
                                                    <li className="menu-item">
                                                        <a className="menu-link" href="modal-onload-iframe.html">
                                                            <div>Video iFrame</div>
                                                        </a>
                                                    </li>
                                                    <li className="menu-item">
                                                        <a className="menu-link" href="modal-onload-subscribe.html">
                                                            <div>Subscription Form</div>
                                                        </a>
                                                    </li>
                                                    <li className="menu-item">
                                                        <a className="menu-link" href="modal-onload-common-height.html">
                                                            <div>Common Height</div>
                                                        </a>
                                                    </li>
                                                    <li className="menu-item">
                                                        <a className="menu-link" href="modal-onload-cookie.html">
                                            ...
                                            <li className="menu-item mega-menu mega-menu-small">
                                                <a className="menu-link" href="#footer" data-scrollto="#footer">
                                                ...
                                                <div className="mega-menu-content">
                                                    <div className="row mx-0">
                                                        <ul className="sub-menu-container mega-menu-column col">
                                                            <li className="menu-item">
                                                                <a className="menu-link" href="sticky-footer.html">
                                                                    <div>Sticky</div>
                                                                </a>
                                                            </li>
                                                            <li className="menu-item">
                                                            ...
                                                            <li className="menu-item">
                                                                <a className="menu-link" href="footer-2.html#footer">
                                                                    <div>Layout 2</div>
                                                                </a>
                                                            </li>
                                                        </ul>
                                                        <ul className="sub-menu-container mega-menu-column col">
                                                            <li className="menu-item">
                                                                <a className="menu-link" href="footer-3.html#footer">
                                                                    <div>Layout 3</div>
                                                                </a>
                                                            </li>
                                                            <li className="menu-item">
                                                                <a className="menu-link" href="footer-4.html#footer">
                                                                    <div>Layout 4</div>
                                                                </a>
                                                            </li>
                                                            <li className="menu-item">
                                                                <a className="menu-link" href="footer-5.html#footer">
                                                                    <div>Layout 5</div>
                                                                </a>
                                                            </li>
                                                        </ul>
                                                        <ul className="sub-menu-container mega-menu-column col">
                                                            <li className="menu-item">
                                                                <a className="menu-link" href="footer-6.html#footer">
                                                                    <div>Layout 6</div>
                                                                </a>
                                                            </li>
                                                            <li className="menu-item">
                                                                <a className="menu-link" href="footer-7.html#footer">
                                                                    <div>Layout 7</div>
                                                                </a>
                                                            </li>
                                                        </ul>
                                                ...
                                                <div className="row">
                                                            ...
                                                            <ul className="sub-menu-container">
                                                                <li className="menu-item">
                                                                    ...
                                                                    <ul className="sub-menu-container mega-menu-dropdown">
                                                                        ...
                                                                        <li className="menu-item">
                                                                            <a className="menu-link" href="about-2.html">
                                                                                <div>Alternate Layout</div>
                                                                            </a>
                                                                        </li>
                                                                        <li className="menu-item">
                                                                            <a className="menu-link" href="about-me.html">
                                                                                <div>About Me</div>
                                                                            </a>
                                                                        </li>
                                                                        <li className="menu-item">
                                                                ...
                                                                <li className="menu-item">
                                                                    ...
                                                                    <ul className="sub-menu-container mega-menu-dropdown">
                                                                        ...
                                                                        <li className="menu-item">
                                                                            <a className="menu-link" href="gdpr-small.html">
                                                                                <div>Small</div>
                                                                            </a>
                                                                        </li>
                                                                    </ul>
                                                            ...
                                                            <ul className="sub-menu-container">
                                                                <li className="menu-item">
                                                                    <a className="menu-link" href="services.html">
                                                                        <div><i className="icon-star-of-life"></i>Services Pages
                                                                        </div>
                                                                    </a>
                                                                    <ul className="sub-menu-container mega-menu-dropdown">
                                                                        <li className="menu-item">
                                                                        ...
                                                                        <li className="menu-item">
                                                                            <a className="menu-link" href="services-2.html">
                                                                                <div>Layout 2</div>
                                                                            </a>
                                                                        </li>
                                                                        <li className="menu-item">
                                                                            <a className="menu-link" href="services-3.html">
                                                                                <div>Layout 3</div>
                                                                            </a>
                                                                        </li>
                                                                    </ul>
                                                                ...
                                                                <li className="menu-item">
                                                                    ...
                                                                    <ul className="sub-menu-container mega-menu-dropdown">
                                                                        <li className="menu-item">
                                                                            <a className="menu-link" href="events-list.html">
                                                                                <div>Events List</div>
                                                                            </a>
                                                                            <ul
                                                                        ...
                                                                        <li className="menu-item">
                                                                            <a className="menu-link" href="event-single.html">
                                                                ...
                                                                <li className="menu-item">
                                                                    <a className="menu-link" href="contact.html">
                                                                        <div><i className="icon-envelope"></i>Contact Pages
                                                                        </div>
                                                                    </a>
                                                                    <ul className="sub-menu-container mega-menu-dropdown">
                                                                        <li className="menu-item">
                                                                            <a className="menu-link" href="contact.html">Main
                                                                                Layout</a>
                                                                        </li>
                                                                        <li className="menu-item">
                                                                            <a className="menu-link" href="contact-2.html">Grid
                                                                                Layout</a>
                                                                        </li>
                                                                        <li className="menu-item">
                                                                            <a className="menu-link" href="contact-3.html">Right
                                                                                Sidebar</a>
                                                                        </li>
                                                                        <li className="menu-item">
                                                                            <a className="menu-link" href="contact-4.html">Both
                                                                                Sidebars</a>
                                                                        </li>
                                                                        <li className="menu-item">
                                                                            <a className="menu-link" href="contact-5.html">Modal
                                                                                Form</a>
                                                                        </li>
                                                                        <li className="menu-item">
                                                                            <a className="menu-link" href="contact-6.html">Form
                                                                                Overlay</a>
                                                                        </li>
                                                                        <li className="menu-item">
                                                                            <a className="menu-link" href="contact-7.html">Form
                                                                                Overlay Mini</a>
                                                                        </li>
                                                                    </ul>
                                                                </li>
                                                                <li className="menu-item">
                                                                    <a className="menu-link" href="faqs.html">
                                                                        <div><i className="icon-question-circle"></i>FAQs Pages
                                                                        </div>
                                                                    </a>
                                                                    <ul className="sub-menu-container mega-menu-dropdown">
                                                                        <li className="menu-item">
                                                        ...
                                                        <li className="menu-item mega-menu-title">
                                                            ...
                                                            <ul className="sub-menu-container">
                                                                ...
                                                                <li className="menu-item">
                                                                    ...
                                                                    <ul className="sub-menu-container mega-menu-dropdown">
                                                                        <li className="menu-item">
                                                                            <a className="menu-link" href="right-sidebar.html">
                                                                                <div>Right Sidebar</div>
                                                                            </a>
                                                                        </li>
                                                                        <li className="menu-item">
                                                                            <a className="menu-link" href="left-sidebar.html">
                                                                                <div>Left Sidebar</div>
                                                                            </a>
                                                                        </li>
                                                                        <li className="menu-item">
                                                                            <a className="menu-link" href="both-sidebar.html">
                                                                                <div>Both Sidebar</div>
                                                                            </a>
                                                                        </li>
                                                                        <li className="menu-item">
                                                                ...
                                                                <li className="menu-item">
                                                                    <a className="menu-link" href="page-submenu.html">
                                                                        <div>Page Submenu</div>
                                                                    </a>
                                                                </li>
                                                                <li className="menu-item">
                                                                    <a className="menu-link" href="side-navigation.html">
                                                    ...
                                                    <ul className="sub-menu-container mega-menu-column col-lg-3">
                                                        <li className="menu-item mega-menu-title">
                                                            ...
                                                            <ul className="sub-menu-container">
                                                                <li className="menu-item">
                                                                    <a className="menu-link" href="login-register.html">
                                                                    ...
                                                                    <ul className="sub-menu-container mega-menu-dropdown">
                                                                        ...
                                                                        <li className="menu-item">
                                                                            <a className="menu-link" href="login-1.html">
                                                                                <div>Dark BG Login</div>
                                                                            </a>
                                                                        </li>
                                                                        <li className="menu-item">
                                                                            <a className="menu-link" href="login-2.html">
                                                                ...
                                                                <li className="menu-item">
                                                                    ...
                                                                    <ul className="sub-menu-container mega-menu-dropdown">
                                                                        ...
                                                                        <li className="menu-item">
                                                                            <a className="menu-link" href="coming-soon-2.html">
                                                                                <div>Parallax Image</div>
                                                                            </a>
                                                                        </li>
                                                                        <li className="menu-item">
                                                                            <a className="menu-link" href="coming-soon-3.html">
                                                                                <div>HTML5 Video</div>
                                                                            </a>
                                                                        </li>
                                                                    </ul>
                                                                ...
                                                                <li className="menu-item">
                                                                    ...
                                                                    <ul className="sub-menu-container mega-menu-dropdown">
                                                                        ...
                                                                        <li className="menu-item">
                                                                            <a className="menu-link" href="maintenance.html">
                                                                                <div>Maintenance Page</div>
                                                                            </a>
                                                                        </li>
                                                                        <li className="menu-item">
                                                                            <a className="menu-link" href="sitemap.html">
                                                                                <div>Sitemap</div>
                                                                            </a>
                                                                        </li>
                                                                    </ul>
                                                ...
                                                <div className="row">
                                                    <ul className="sub-menu-container mega-menu-column col">
                                                        <li className="menu-item mega-menu-title">
                                                            ...
                                                            <ul className="sub-menu-container">
                                                                ...
                                                                <li className="menu-item">
                                                                    <a className="menu-link" href="portfolio-2.html">
                                                                        <div>2 Columns</div>
                                                                    </a>
                                                                </li>
                                                                <li className="menu-item">
                                                                    <a className="menu-link" href="portfolio-3.html">
                                                                        <div>3 Columns</div>
                                                                    </a>
                                                                </li>
                                                                <li className="menu-item">
                                                                ...
                                                                <li className="menu-item">
                                                                    <a className="menu-link" href="portfolio-5.html">
                                                                        <div>5 Columns</div>
                                                                    </a>
                                                                </li>
                                                                <li className="menu-item">
                                                                    <a className="menu-link" href="portfolio-6.html">
                                                                        <div>6 Columns</div>
                                                                    </a>
                                                                </li>
                                                            </ul>
                                                    ...
                                                    <ul className="sub-menu-container mega-menu-column col">
                                                        <li className="menu-item mega-menu-title">
                                                            ...
                                                            <ul className="sub-menu-container">
                                                                ...
                                                                <li className="menu-item">
                                                                    <a className="menu-link" href="portfolio-2-masonry.html">
                                                                        <div>2 Columns</div>
                                                                    </a>
                                                                </li>
                                                                <li className="menu-item">
                                                                    <a className="menu-link" href="portfolio-3-masonry.html">
                                                                        <div>3 Columns</div>
                                                                    </a>
                                                                </li>
                                                                <li className="menu-item">
                                                                    <a className="menu-link" href="portfolio-masonry.html">
                                                                        <div>4 Columns</div>
                                                                    </a>
                                                                </li>
                                                                <li className="menu-item">
                                                                    <a className="menu-link" href="portfolio-5-masonry.html">
                                                                        <div>5 Columns</div>
                                                                    </a>
                                                                </li>
                                                                <li className="menu-item">
                                                                    <a className="menu-link" href="portfolio-6-masonry.html">
                                                                        <div>6 Columns</div>
                                                                    </a>
                                                                </li>
                                                            </ul>
                                                    ...
                                                    <ul className="sub-menu-container mega-menu-column col">
                                                        <li className="menu-item mega-menu-title">
                                                            ...
                                                            <ul className="sub-menu-container">
                                                                ...
                                                                <li className="menu-item">
                                                                    <a className="menu-link" href="portfolio-jpagination.html">
                                                                ...
                                                                <li className="menu-item">
                                                                    <a className="menu-link" href="portfolio-ajax.html">
                                                    ...
                                                    <ul className="sub-menu-container mega-menu-column col">
                                                        <li className="menu-item mega-menu-title">
                                                            ...
                                                            <ul className="sub-menu-container">
                                                                <li className="menu-item">
                                                                    <a className="menu-link" href="portfolio-nomargin.html">
                                                                        <div>Default</div>
                                                                    </a>
                                                                </li>
                                                                <li className="menu-item">
                                                                ...
                                                                <li className="menu-item">
                                                                    <a className="menu-link" href="portfolio-parallax.html">
                                                                        <div>Parallax</div>
                                                                    </a>
                                                                </li>
                                                            </ul>
                                                ...
                                                <div className="row">
                                                    <ul className="sub-menu-container mega-menu-column col-lg-3">
                                                        <li className="menu-item mega-menu-title">
                                                            ...
                                                            <ul className="sub-menu-container">
                                                                ...
                                                                <li className="menu-item">
                                                                    <a className="menu-link" href="blog-left-sidebar.html">
                                                                        <div>Left Sidebar</div>
                                                                    </a>
                                                                </li>
                                                                <li className="menu-item">
                                                                    <a className="menu-link" href="blog-both-sidebar.html">
                                                                        <div>Both Sidebar</div>
                                                                    </a>
                                                                </li>
                                                                <li className="menu-item">
                                                                    <a className="menu-link" href="blog-full-width.html">
                                                                        <div>Full Width</div>
                                                                    </a>
                                                                </li>
                                                            </ul>
                                                        ...
                                                        <li className="menu-item mega-menu-title">
                                                            ...
                                                            <ul className="sub-menu-container">
                                                                ...
                                                                <li className="menu-item">
                                                                    <a className="menu-link" href="blog-timeline.html">
                                                                        <div>Full Width</div>
                                                                    </a>
                                                                </li>
                                                            </ul>
                                                    ...
                                                    <ul className="sub-menu-container mega-menu-column col-lg-3">
                                                        <li className="menu-item mega-menu-title">
                                                            ...
                                                            <ul className="sub-menu-container">
                                                                <li className="menu-item">
                                                                    <a className="menu-link" href="blog-masonry.html">
                                                                        <div>4 Columns</div>
                                                                    </a>
                                                                </li>
                                                                <li className="menu-item">
                                                                    <a className="menu-link" href="blog-masonry-3.html">
                                                                        <div>3 Columns</div>
                                                                    </a>
                                                                </li>
                                                                <li className="menu-item">
                                                                    <a className="menu-link" href="blog-masonry-2.html">
                                                                        <div>2 Columns</div>
                                                                    </a>
                                                                </li>
                                                                <li className="menu-item">
                                                                    <a className="menu-link" href="blog-masonry-full.html">
                                                                        <div>100% Width</div>
                                                                    </a>
                                                                </li>
                                                            </ul>
                                                        ...
                                                        <li className="menu-item mega-menu-title">
                                                            ...
                                                            <ul className="sub-menu-container">
                                                                ...
                                                                <li className="menu-item">
                                                                    <a className="menu-link" href="blog-grid-3.html">
                                                                        <div>3 Columns</div>
                                                                    </a>
                                                                </li>
                                                                <li className="menu-item">
                                                                    <a className="menu-link" href="blog-grid-2.html">
                                                                        <div>2 Columns</div>
                                                                    </a>
                                                                </li>
                                                            </ul>
                                                    ...
                                                    <ul className="sub-menu-container mega-menu-column col-lg-3">
                                                        <li className="menu-item mega-menu-title">
                                                            ...
                                                            <ul className="sub-menu-container">
                                                                ...
                                                                <li className="menu-item">
                                                                    <a className="menu-link" href="blog-small-full-width.html">
                                                                        <div>Full Width</div>
                                                                    </a>
                                                                </li>
                                                                <li className="menu-item">
                                                                    <a className="menu-link" href="blog-small-alt.html">
                                                                        <div>Alternate Layout</div>
                                                                    </a>
                                                                </li>
                                                            </ul>
                                                    ...
                                                    <ul className="sub-menu-container mega-menu-column col-lg-3">
                                                        <li className="menu-item mega-menu-title">
                                                            ...
                                                            <ul className="sub-menu-container">
                                                                <li className="menu-item">
                                                                    <a className="menu-link" href="blog-single.html">
                                                                        <div>Default Layout</div>
                                                                    </a>
                                                                </li>
                                                                <li className="menu-item">
                                                                ...
                                                                <li className="menu-item">
                                                                    <a className="menu-link" href="blog-single-full.html">
                                                                        <div>Full Width</div>
                                                                    </a>
                                                                </li>
                                                                <li className="menu-item">
                                                                    <a className="menu-link" href="blog-single-small.html">
                                                                        <div>Small Image</div>
                                                                    </a>
                                                                </li>
                                                                <li className="menu-item">
                                        ...
                                        <ul className="sub-menu-container">
                                            ...
                                            <li className="menu-item">
                                                ...
                                                <ul className="sub-menu-container">
                                                    ...
                                                    <li className="menu-item">
                                                        <a className="menu-link" href="shop-3-right-sidebar.html">
                                                            <div>Right Sidebar</div>
                                                        </a>
                                                    </li>
                                                    <li className="menu-item">
                                                        <a className="menu-link" href="shop-3-left-sidebar.html">
                                                            <div>Left Sidebar</div>
                                                        </a>
                                                    </li>
                                                </ul>
                                            ...
                                            <li className="menu-item">
                                                ...
                                                <ul className="sub-menu-container">
                                                    ...
                                                    <li className="menu-item">
                                                        <a className="menu-link" href="shop-2-left-sidebar.html">
                                                            <div>Left Sidebar</div>
                                                        </a>
                                                    </li>
                                                    <li className="menu-item">
                                                        <a className="menu-link" href="shop-2-both-sidebar.html">
                                                            <div>Both Sidebar</div>
                                                        </a>
                                                    </li>
                                                </ul>
                                            ...
                                            <li className="menu-item">
                                                ...
                                                <ul className="sub-menu-container">
                                                    ...
                                                    <li className="menu-item">
                                                        <a className="menu-link" href="shop-1-right-sidebar.html">
                                                            <div>Right Sidebar</div>
                                                        </a>
                                                    </li>
                                                    <li className="menu-item">
                                                        <a className="menu-link" href="shop-1-left-sidebar.html">
                                                            <div>Left Sidebar</div>
                                                        </a>
                                                    </li>
                                                    <li className="menu-item">
                                                        <a className="menu-link" href="shop-1-both-sidebar.html">
                                                            <div>Both Sidebar</div>
                                                        </a>
                                                    </li>
                                                </ul>
                                            ...
                                            <li className="menu-item">
                                                <a className="menu-link" href="shop-category-parallax.html">
                                                    <div>Categories - Parallax</div>
                                                </a>
                                            </li>
                                            <li className="menu-item">
                                                <a className="menu-link" href="shop-combination-filter.html">
                                            ...
                                            <li className="menu-item">
                                                ...
                                                <ul className="sub-menu-container">
                                                    ...
                                                    <li className="menu-item">
                                                        <a className="menu-link" href="shop-single-right-sidebar.html">
                                                            <div>Right Sidebar</div>
                                                        </a>
                                                    </li>
                                                    <li className="menu-item">
                                                        <a className="menu-link" href="shop-single-left-sidebar.html">
                                                            <div>Left Sidebar</div>
                                                        </a>
                                                    </li>
                                                    <li className="menu-item">
                                                        <a className="menu-link" href="shop-single-both-sidebar.html">
                                                            <div>Both Sidebar</div>
                                                        </a>
                                                    </li>
                                                    <li className="menu-item">
                                                        <a className="menu-link" href="shop-single-color.html">
                                                            <div>Color Options</div>
                                                        </a>
                                                    </li>
                                                    <li className="menu-item">
                                                        <a className="menu-link" href="shop-single-sticky.html">
                                            ...
                                            <div className="container">
                                                <div className="row">
                                                    <ul className="sub-menu-container mega-menu-column col">
                                                        ...
                                                        <li className="menu-item">
                                                            <a className="menu-link" href="read-more.html">
                                                                <div><i className="icon-ellipsis-h"></i>Read More</div>
                                                            </a>
                                                        </li>
                                                        <li className="menu-item">
                                                            <a className="menu-link" href="component-datatable.html">
                                                                <div><i className="icon-table"></i>Data Tables</div>
                                                            </a>
                                                        </li>
                                                        <li className="menu-item">
                                                            <a className="menu-link" href="component-datepicker.html">
                                                                <div><i className="icon-calendar3"></i>Date &amp; Time Pickers
                                                                </div>
                                                            </a>
                                                        </li>
                                                    </ul>
                                                    <ul className="sub-menu-container mega-menu-column col">
                                                        ...
                                                        <li className="menu-item">
                                                            <a className="menu-link" href="headings-dropcaps.html">
                                                        ...
                                                        <li className="menu-item">
                                                            <a className="menu-link" href="gradients.html">
                                                                <div><i className="icon-tint"></i>Gradients</div>
                                                            </a>
                                                        </li>
                                                        <li className="menu-item">
                                                        ...
                                                        <li className="menu-item">
                                                            <a className="menu-link" href="item-overlays.html">
                                                                <div><i className="icon-line-marquee-plus"></i>Item Overlays
                                                                </div>
                                                            </a>
                                                        </li>
                                                        <li className="menu-item">
                                                        ...
                                                        <li className="menu-item">
                                                            <a className="menu-link" href="component-uploads.html">
                                                    ...
                                                    <ul className="sub-menu-container mega-menu-column col">
                                                        ...
                                                        <li className="menu-item">
                                                            <a className="menu-link" href="pagination-progress.html">
                                                                <div><i className="icon-cogs"></i>Pagination</div>
                                                            </a>
                                                        </li>
                                                        <li className="menu-item">
                                                            <a className="menu-link" href="pie-skills.html">
                                                                <div><i className="icon-tasks"></i>Pies &amp; Skills</div>
                                                            </a>
                                                        </li>
                                                        <li className="menu-item">
                                                            <a className="menu-link" href="shape-dividers.html">
                                                                <div><i className="icon-shapes"></i>Shape Dividers</div>
                                                            </a>
                                                        </li>
                                                        <li className="menu-item">
                                                            <a className="menu-link" href="component-range-slider.html">
                                                                <div><i className="icon-line-move"></i>Range Slider</div>
                                                            </a>
                                                        </li>
                                                        <li className="menu-item">
                                                            <a className="menu-link" href="component-ratings.html">
                                                    ...
                                                    <ul className="sub-menu-container mega-menu-column col">
                                                        ...
                                                        <li className="menu-item">
                                                            <a className="menu-link" href="quotes-blockquotes.html">
                                                        ...
                                                        <li className="menu-item">
                                                            <a className="menu-link" href="hover-animations.html">
                                                                <div><i className="icon-hand-pointer"></i>Hover Animations</div>
                                                            </a>
                                                        </li>
                                                        <li className="menu-item">
                                                            <a className="menu-link" href="component-select-picker.html">
                                                                <div><i className="icon-select"></i>Select Picker</div>
                                                            </a>
                                                        </li>
                                                        <li className="menu-item">
                                                            <a className="menu-link" href="component-select-box.html">
                                                    ...
                                                    <ul className="sub-menu-container mega-menu-column col">
                                                        ...
                                                        <li className="menu-item">
                                                            <a className="menu-link" href="testimonials-twitter.html">
                                                                <div><i className="icon-user4"></i>Testimonials</div>
                                                            </a>
                                                        </li>
                                                        <li className="menu-item">
                                                            <a className="menu-link" href="thumbnails-slider.html">
                                                                <div><i className="icon-camera3"></i>Thumbnails</div>
                                                            </a>
                                                        </li>
                                                        <li className="menu-item">
                                                            <a className="menu-link" href="toggles-accordions.html">
                                                                <div><i className="icon-ok-circle"></i>Toggles</div>
                                                            </a>
                                                        </li>
                                                        <li className="menu-item">
                                                            <a className="menu-link" href="lazy-loading.html">
                                                                <div><i className="icon-line-loader"></i>Lazy Loading</div>
                                                            </a>
                                                        </li>
                                                        <li className="menu-item">
                                                            <a className="menu-link" href="component-radios-switches.html">
                                                                <div><i className="icon-line-square-check"></i>Radios &amp;
                                                                    Switches</div>
                                                            </a>
                                                        </li>
                                                        <li className="menu-item">
