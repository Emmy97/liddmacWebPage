...
export const Footer = () => {
    return (
        ...
        //                                 <img src="src/images/footer-widget-logo.png" alt="Image" className="footer-logo" />
        //                                 <p>We believe in <strong>Simple</strong>, <strong>Creative</strong> &amp; <strong>Flexible</strong> Design Standards.</p>
        //                                 <div style={{ background: 'url("src/images/world-map.png") no-repeat center center', backgroundSize: '100%' }}>
        //                                     <address>
        ...
        //                                         <div className="counter counter-small"><span data-from={50} data-to={15065421} data-refresh-interval={80} data-speed={3000} data-comma="true" /></div>
        //                                         <h5 className="mb-0">Total Downloads</h5>
        //                                     </div>
        //                                     <div className="col-lg-6 bottommargin-sm">
        //                                         <div className="counter counter-small"><span data-from={100} data-to={18465} data-refresh-interval={50} data-speed={2000} data-comma="true" /></div>
        ...
        //                                         <a href="#" className="social-icon si-dark si-colored si-facebook mb-0" style={{ marginRight: 10 }}>
        //                                             <i className="icon-facebook" />
        //                                             <i className="icon-facebook" />
        //                                         </a>
        //                                         <a href="#"><small style={{ display: 'block', marginTop: 3 }}><strong>Like us</strong><br />on Facebook</small></a>
        //                                     </div>
        //                                     <div className="col-6 col-md-12 col-lg-6 clearfix">
        //                                         <a href="#" className="social-icon si-dark si-colored si-rss mb-0" style={{ marginRight: 10 }}>
        //                                             <i className="icon-rss" />
        //                                             <i className="icon-rss" />
        //                                         </a>
        //                                         <a href="#"><small style={{ display: 'block', marginTop: 3 }}><strong>Subscribe</strong><br />to RSS Feeds</small></a>
        //                                     </div>
        //                                 </div>
        //                             </div>
        //                         </div>
